...
if __name__ == '__main__':
    ...
    layer_last_arr = [128]  # fine-tuning
    pad = 'VALID'
    ...
    lr_arr = [0.0075, 0.0001, 0.01, 0.005]
    ################# en hyper param ############################
    ...
    # for i in [9]:
                ...
                for mntr_tmp in mntr_arr:
                    for batch_epoch_arr in batch_epoch_list:
                        ...
                        with keras.utils.CustomObjectScope(
                            ...
                            opt = 'Fine_' + str(i) + '_lr_{}_fc_{}_feat_{}_last_{}'.format(learning_rate, fc_1, feat, last)
                            print("[OPT]", opt)
        ...
        del train_X, train_Feature, train_Y, test_x, test_f, ans_y
